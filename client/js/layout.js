...
// const swiper2 = new Swiper(".recommend__imgbox", {
//   autoplay: {
//     delay: 2000,
//     disableOnInteraction: false,
//   },
...
//   navigation: {
//     // 네비게이션 설정
//     nextEl: ".swiper-button-next.img", // 다음 버튼 클래스명
//     prevEl: ".swiper-button-prev.img", // 이번 버튼 클래스명
//   },
// });
...
//   setTimeout(() => {
//     //  이미지에 그라데이션 넣기 위해서 backgroundImage로 줌
...
// function moveImage() {
//   //이미지가 자동 슬라이드 되도록 만들고 마우스가 이미지를 가르킬시 잠깐 멈추고 다시 마우스가 이미지 밖으로 나가면 슬라이드 되도록 만듬.
...
// function prevImage() {
//   // 이전 버튼 누르면 이전 이미지 가장 낮은 인덱스이면 가장 높은 인덱스 이미지가 나올수 있도록 만듬
...
// function dotMove() {
//   // dot 버튼은 화면에 나오는 인덱스 이미지에 맞춰 해당 인덱스 dot 에 하얀색 background가 들어오게 만듬. 그리고 dot 버튼을 클릭시 해당 dot 인덱스와 같은 인덱스의 이미지가 나옴
...
//   } else {
//     document.getElementById("scrollHeader").style.backgroundColor =
//       "transparent";
//   }
// });
...
// document
//   .querySelector(".banner__slider__prev")
//   .addEventListener("click", prevImage);
// document
//   .querySelector(".banner__slider__next")
